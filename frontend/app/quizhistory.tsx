...
export default function QuizHistoryScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FDF3E3]">
      {/* Header and Stats */}
      <View style={{ backgroundColor: '#459B6C' }} className="pb-2">
        <View className="flex-row items-center justify-center px-4 pt-4 relative mb-2">
        ...
        {/* Stats Header */}
       <View style={{ backgroundColor: '#459B6C' }} className="px-4 py-5 rounded-b-2xl mb-4">
        {/* First Row: Labels */}
        <View className="flex-row justify-between mb-1">
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-l font-semibold text-center leading-tight">Total Quiz</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-l font-semibold text-center leading-tight">Average Score</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-l font-semibold text-center leading-tight">Highest Score</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-l font-semibold text-center leading-tight">Total Point</Text>
            </View>
        </View>
        ...
        <View className="flex-row justify-between mt-1">
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-3xl font-bold text-center">{totalQuiz}</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-3xl font-bold text-center">{avgScore}%</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-3xl font-bold text-center">{highestScore}%</Text>
            </View>
            <View className="flex-1 items-center">
            <Text className="text-[#F8EFDD] text-3xl font-bold text-center">{totalPoints}</Text>
            </View>
        </View>
        </View>
      ...
      <View className="px-4 my-4">
        ...
        <TouchableOpacity
          ...
          className="flex-row justify-between items-center bg-white border border-gray-300 px-4 py-3 rounded-lg"
        >
