      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-5 mb-3">
          ...
          <View className="flex-row flex-wrap justify-between">
            ...
            {/* Granite */}
            <TouchableOpacity className="w-[47%] bg-white rounded-xl mb-3 overflow-hidden border border-gray-200 shadow-sm" activeOpacity={0.8}>
        ...
        <View className="px-5 mb-10">
          ...
          {sampleArticles.map((article) => (
            <TouchableOpacity
              key={article.id}
              className="flex-row mb-4 bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm"
              activeOpacity={0.8}
