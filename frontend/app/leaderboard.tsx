...
useEffect(() => {
  ...
  const getProfileImage = (img?: any) => {
    ...
    return fallbackImage; // fallback local image
  };
                ...
                return (
                  ...
                  >
                    <View className="flex-row items-center">
                      ...
                      <Text
                        className={`text-sm w-[140px] truncate ${isMe ? 'text-pink-600 font-semibold' : 'text-gray-800'}`}
                        numberOfLines={1}
                        ellipsizeMode="tail"
                      >
                        {isMe ? 'You' : item.name}
                    ...
                    <Text className={`text-sm ${isMe ? 'font-bold text-pink-600' : 'font-normal text-gray-700'}`}>
                      {item.points} pts
                    </Text>
                  </View>
                );
